  ...
  return (
    <Screen appBarProps={appBarProps}>
      <Container maxWidth="md">
        <Card
          mt={2}
          title={t(`dpo__new.requests.acces.error.${errorStatus}.title`)}
        >
          <Typography classes={{ root: classes.typographyRoot }}>
            <Trans i18nKey={`dpo__new.requests.acces.error.${errorStatus}.desc`}>
...
export default withTranslation(['dpo__new'])(AccessRequestError);
