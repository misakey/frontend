  ...
  (
    ...
    return (alreadyExists
      ...
      .then((response) => {
        ...
        enqueueSnackbar(t('admin:sso.redirectUri.success'), { variant: 'success' });
...
const SSORedirectUri = ({ appBarProps, t, service, dispatchUpdateEntities, history }) => {
  ...
  return (
    <ScreenAction
      ...
      title={t('admin:sso.redirectUri.title')}
    >
      <Container maxWidth="md">
        <Typography variant="body2" color="textSecondary" gutterBottom>
          {t('admin:sso.redirectUri.subtitle')}
        </Typography>
        <Formik
...
export default connect(null, mapDispatchToProps)(
  withTranslation(['admin', 'fields', 'common'])(SSORedirectUri),
);
