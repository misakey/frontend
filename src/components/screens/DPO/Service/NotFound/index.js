    ...
    <Screen>
      <Container maxWidth="md" className={classes.container}>
        ...
        <Typography variant="h5" component="h3" color="textSecondary">
          {t('dpo:services.notFound.title', { mainDomain })}
        </Typography>
        <Box my={4}>
          <CardSimpleText
            my={1}
            text={t('dpo:services.notFound.create.text', { mainDomain })}
            button={{
              text: t('dpo:services.notFound.create.button'),
...
export default (withTranslation(['dpo'])(ServiceNotFound));
