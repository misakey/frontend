...
import getUserInfoBuilder from '@misakey/core/auth/builder/userinfo';
...
export default class UserManager extends OidcClient {
  ...
  constructor(
    { enableAutomaticSilentRenew = false, ...settings } = {},
    ...
    this.#userValue = null;
    this.enableAutomaticSilentRenew = enableAutomaticSilentRenew;
  ...
  loadSilentAuthTimer() {
    if (this.enableAutomaticSilentRenew === false) {
      return;
    }
